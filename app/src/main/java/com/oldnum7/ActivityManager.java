...
//        EventBus.getDefault().unregister(this);
    ...
    public Activity removeActivity(int location) {
        if (mActivityList == null) {
            Log.e(TAG, "mActivityList == null when removeActivity(int)");
            return null;
        }
        synchronized (ActivityManager.class) {
    ...
    public void killActivity(Class<?> activityClass) {
        if (mActivityList == null) {
            Log.e(TAG, "mActivityList == null when killActivity");
            return;
        }
    ...
    public boolean activityInstanceIsLive(Activity activity) {
        if (mActivityList == null) {
            Log.e(TAG, "mActivityList == null when activityInstanceIsLive");
            return false;
        }
    ...
    public boolean activityClassIsLive(Class<?> activityClass) {
        if (mActivityList == null) {
            Log.e(TAG, "mActivityList == null when activityClassIsLive");
            return false;
        }
        for (Activity activity : mActivityList) {
            if (activity.getClass().equals(activityClass)) {
